...
function removeVowels(str) {
    newArr = Array.from(str.toLowerCase());
    let vowels = 'aeiou';
    return newArr.filter(function(char){
...
function doubleOddNumbers(arr) {
    ...
    const negs = arr.filter(function(n){
        return n % 2 !== 0;
    })
    
    const negDoubles = negs.map(function(num){
        return num * 2;
    })
